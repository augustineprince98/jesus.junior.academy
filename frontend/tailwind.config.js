...
module.exports = {
  ...
  theme: {
    extend: {
      colors: {
        // School brand colors - refined palette
        campus: {
          sky: '#87CEEB',
          grass: '#4A7C59',
          building: '#D4B896',
        ...
        // Accent - Gold/Amber for achievements
        gold: {
          50: '#FFFBEB',
          100: '#FEF3C7',
          200: '#FDE68A',
      ...
      backgroundImage: {
        ...
        'hero-pattern': 'radial-gradient(circle at 1px 1px, rgba(30,58,95,0.05) 1px, transparent 0)',
      },
      backdropBlur: {
        xs: '2px',
      },
